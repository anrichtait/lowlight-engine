...
bool Shader::g3dLoadTimePreprocessor(const String& dir, PreprocessedShaderSource& source, String& messages, GLuint stage, const Args& args) {
    ...
    if (ok) {
        ...
        String defineString =
            ...
            "\n#define G3D_MESH_SHADER (38233)"//0x9559)"
            "\n#define G3D_TASK_SHADER (38234)"//0x955A)"
...
#       endif
        ...
        case GL_TASK_SHADER_NV:
            defineString += "#define G3D_SHADER_STAGE G3D_TASK_SHADER\n";
            break;
        case GL_MESH_SHADER_NV:
            defineString += "#define G3D_SHADER_STAGE G3D_MESH_SHADER\n";
            break;
