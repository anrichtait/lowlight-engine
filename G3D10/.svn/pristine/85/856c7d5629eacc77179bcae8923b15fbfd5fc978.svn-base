...
void GLCaps::init(OSWindow::Settings::API api) {
    ...
    if ((s_api != OSWindow::Settings::API_OPENGL_ES) && (s_api != OSWindow::Settings::API_OPENGL_EGL)) {
...
#   ifdef GLEW_EGL
    alwaysAssertM(glGetCurrentContext() || eglGetCurrentContext(), "Unable to load OpenGL extensions without a current context.");
#   else
