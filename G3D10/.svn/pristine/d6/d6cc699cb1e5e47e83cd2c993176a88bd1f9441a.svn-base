...
public:
    enum TriTreeGPUAPI { OPTIX, VULKAN };
    ...
    const shared_ptr<TriTree>& tritree(TriTreeGPUAPI gpuApi = TriTreeGPUAPI::OPTIX);
...
public:
    ...
    */
    ...
    void setLightingEnvironment(shared_ptr<LightingEnvironment> lighting) {
        m_localLightingEnvironment = *lighting;
    }
