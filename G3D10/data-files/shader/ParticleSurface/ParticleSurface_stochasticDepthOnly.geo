...
void emit(float x, float y) {
    ...
    texCoord.xy = Point2(x, y) * (0.5 * float(texelWidth) * material2DArray.lambertian.invSize.xy) + Vector2(0.5, 0.5);
