...
void TextureViewer::onInit(const G3D::String& filename, App* app) {
...
void TextureViewer::onGraphics2D(RenderDevice* rd, Array<shared_ptr<Surface2D> >& surface2D) {
	if (! m_isSky) {
...
void TextureViewer::onGraphics3D(RenderDevice* rd, Array<shared_ptr<Surface> >& surfaceArray) {
    if (m_isSky) {
